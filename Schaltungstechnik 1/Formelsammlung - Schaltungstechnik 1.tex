...
Eintrag $a_{\alpha\beta}=\begin{cases}+1,&\text{Zweig }\beta\leftarrow\text{Knoten }\alpha\\-1,&\text{Zweig }\beta\rightarrow\text{Knoten }\alpha\\\pm0,&\text{Kein Zweig }\beta\leftrightarrow\text{Knoten }\alpha\end{cases}$\\
...
n: Anzahl der Knoten\\\\
KVL in Matrixform:\\
Nullraumdarstellung: $\underline{u}-\textbf{A}^T\cdot \underline{u_k}=\underline{0}$\\
