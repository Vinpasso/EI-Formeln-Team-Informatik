...
\begin{tabular}{p{0.15\linewidth}|p{0.25\linewidth}|p{0.075\linewidth}|p{0.2\linewidth}|p{0.1\linewidth}}
	Zahlensystem & Add & Sub & Mul & Div \\
  \hline
	Vorzeichenlos & Normal & Normal & Normal & Normal \\
  \hline
	Einser Komplement & Vorzeichen Vergleichen & & & \\
  \hline
	Zweier Komplement & Normal & Normal & $n+m bit$ Vordere Bits mit Multiplikant MSB auffüllen & \\
  \hline
	Float &&&& \\
\end{tabular}
\begin{itemize}
...
\parbox{4.0cm}{ \includegraphics{./img/ds/mosfet.pdf} \\ $V_{Pinch-Off} = V_{GS} - V_{th}$ } \parbox{3.0cm}{ \includegraphics{./img/ds/char_nmos.pdf} }
	...
	\end{tabular}\\[0.5cm]
	\emph{Vorsicht:} $U_{GS,p}=V_{DD}-U_a$
	}
	\subsection{Kondensatoraufgaben}
	...
	\begin{minipage}{0.55\linewidth}
		...
		$\rightarrow C$ lädt, solange $u_{gs}-U_{th}\ge 0$ und $u_{ds}\ge 0$
...
Drei Grundgatter der CMOS-Technologie:\\
  ...
  \resizebox{0.95\linewidth}{!}{
    \begin{tabular}{c||c|c|c}
      Gatter & Funktion & \textbf{NAND} Form & \textbf{NOR} Form \\
      \hline
      \textbf{NOT} & $\overline{A}$ & $\overline{A \cdot A} $ & $\overline{A + A} $\\\hline&&&\\[-1em]
      \textbf{AND} & $A \cdot B$ & $\overline{\overline{A \cdot B} \cdot \overline{A \cdot B}}$ & $\overline{\overline{A + A} + \overline{B + B}}$\\\hline&&&\\[-1em]
      \textbf{OR} & $A + B$ & $\overline{\overline{A \cdot A} \cdot \overline{B \cdot B}}$ & $\overline{\overline{A + B} + \overline{A + B}}$\\\hline&&&\\[-1em]
      \textbf{NAND} & $\overline{A \cdot B}$ & $\overline{A \cdot B}$ & $\overline{\overline{\overline{A + A} + \overline{B + B}}+ \overline{\overline{A + A} + \overline{B + B}}}$ \\\hline&&&\\[-1em]
      \textbf{NOR} & $\overline{A+B}$ & $\overline{\overline{\overline{A \cdot A} \cdot \overline{B \cdot B}}\cdot \overline{\overline{A \cdot A} \cdot \overline{B \cdot B}}}$ &  $\overline{A+B}$\\
    \end{tabular}
  }
