...
\section{Logikminimierung}
	...
	\emph{Immer vollständig Nullen und Eines ausfüllen}
...
Drei Grundgatter der CMOS-Technologie:\\
	...
	$(V_{tn},V_{DD}/2)\rightarrow$ nMOS-Sättigung\\
	$(V_{DD}/2, V_{DD} - V_{tp})\rightarrow$ pMOS-Sättigung\\
	Mittig beide gesättigt.\\
